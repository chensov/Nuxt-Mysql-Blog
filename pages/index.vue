<template>
    <div class="w-full max-w-3xl mx-auto py-8">
        <div class="text-xl font-semibold">My Blog Crud</div>
        ...
        <section class="flex flex-col items-center">
            <div class="flex max-w-xl flex-col items-center pb-16 pt-8 text-center lg:pb-48 lg:pt-32">
                <p class="mb-4 font-semibold text-indigo-500 md:mb-6 md:text-lg xl:text-xl">I love Nuxt.js</p>

                <h1 class="mb-8 text-4xl font-bold text-black sm:text-5xl md:mb-12 md:text-6xl">Mini crud system for creating a blog on nuxt + ts + mysql</h1>
